...
#define BBLEANSKIN_FOCUSTRANS	"BBLEANSKIN_FOCUSTRANS"
#define BBLEANSKIN_UNFOCUSTRANS "BBLEANSKIN_APPLIEDTRANS"
...
struct SkinStruct
{
	...
	COLORREF focusColorTrans;
	COLORREF unfocusColorTrans;
	...
	char	focusAlphaMethod[128];
	char	unfocusAlphaMethod[128];
};
