...
#define switch_rgb(c) (((c)&0x0000ff)<<16 | ((c)&0x00ff00) | ((c)&0xff0000)>>16)
#define greyvalue(c) ((GetRValue((c))*77 + GetGValue((c))*150 + GetBValue((c))*29)>>8)
...
void read_extension_style(LPCSTR fileName, LPCSTR szKey);
